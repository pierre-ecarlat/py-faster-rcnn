...
def parse_rec(filename):
    """ Parse a Foodinc sample txt file """
...
def foodinc_sample_ap(rec, prec):
    """ ap = foodinc_sample_ap(rec, prec)
    Compute Foodinc sample AP given precision and recall.
    """
...
def foodinc_sample_eval(detpath,
                        annopath,
                        imagesetfile,
                        classname,
                        class_id,
    ...
    Top level function that does the Foodinc sample evaluation.
    ...
    # print('Class, class_id, detfile: {} {} {}'.format(classname, class_id, detfile))
    # print('splitlines')
    # print(splitlines)
    # print('image_ids')
    # print(image_ids)
