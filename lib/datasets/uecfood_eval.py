...
def uecfood_ap(rec, prec):
    """ ap = uecfood_ap(rec, prec)
    Compute UECFOOD AP given precision and recall.
    """
...
def uecfood_eval(detpath,
                 ...
                 cachedir,
                 ovthresh=0.5):
    """rec, prec, ap = uecfood_eval(detpath,
                                    annopath,
                                    imagesetfile,
                                    classname,
                                    class_id,
    ...
    Top level function that does the UECFOOD evaluation.
