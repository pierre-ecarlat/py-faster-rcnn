...
class foodinc_sample(imdb):
    def __init__(self, image_set, year, devkit_path=None):
        imdb.__init__(self, 'foodinc_sample_' + year + '_' + image_set)
        self._year = year
    ...
    def _get_default_path(self):
        ...
        """
        return os.path.join(cfg.DATA_DIR, 'Foodinc_sample_' + self._year)
    ...
    def gt_roidb(self):
        ...
        gt_roidb = [self._load_foodinc_sample_annotation(index)
    ...
    def _load_foodinc_sample_annotation(self, index):
        """
    ...
    def _get_foodinc_sample_results_file_template(self):
    ...
    def _write_foodinc_sample_results_file(self, all_boxes):
